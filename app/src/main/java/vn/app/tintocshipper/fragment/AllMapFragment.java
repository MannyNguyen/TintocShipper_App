...
public class AllMapFragment extends BaseFragment implements View.OnClickListener, OnMapReadyCallback {
    //region Var
    GoogleMap map;
    ImageView ivBack;
    ...
    public static AllMapFragment newInstance(String data) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_all_map, container, false);
        }
        return view;
    }
    //endregion
            ...
            case R.id.iv_back:
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            Thread.sleep(2000);
                            ivBack.setOnClickListener(AllMapFragment.this);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    ft.add(R.id.container_all_map, mapFragment)
                            .commit();
                    getActivity().runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            mapFragment.getMapAsync(AllMapFragment.this);
                        }
                    });
                ...
                .addOnSuccessListener(getActivity(), new OnSuccessListener<Location>() {
                    ...
                    public void onSuccess(Location location) {
                        if (location != null) {
                            ...
                            //new GetLatLngByAddress().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, address);
//                            new GetLatLngByAddress().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, "124, Trần Hưng Đạo, Hồ Chí Minh");
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                orderList = (List<Order>) CmmFunc.tryParseList(getArguments().getString("data"), Order.class);
